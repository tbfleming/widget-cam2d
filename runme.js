...
var evalWidgetJs = function() {
  ...
  //fs.writeFileSync('widget-cam2d.js', widgetSrc);
  
  eval(widgetSrc);
  //console.log("evaled the widget-cam2d.js");
  //isEvaled = true;
...
`
  ...
  var testUrl = 'https://preview.c9users.io/' +
    process.env.C9_USER + '/' +
    process.env.C9_PROJECT + '/widget-cam2d.html';
  var editUrl = 'http://ide.c9.io/' +
    process.env.C9_USER + '/' +
    process.env.C9_PROJECT;
  var github = getGithubUrl();
...
`;
  ...
  var testUrlNoSsl = 'http://' + process.env.C9_PROJECT +
    '-' + process.env.C9_USER + '.c9users.io/widget-cam2d.html';
  var editUrl = 'http://ide.c9.io/' +
    process.env.C9_USER + '/' +
    process.env.C9_PROJECT;
  var github = getGithubUrl();
...
var generateInlinedFile = function() {
  ...
  var fileCss = fs.readFileSync("widget-cam2d.css").toString();
  var fileHtml = fs.readFileSync("widget-cam2d.html").toString();
  var fileJs = widgetSrc; // fs.readFileSync("widget-cam2d.js").toString();
