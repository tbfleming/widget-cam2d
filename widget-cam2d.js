            ...
            return h('div', [
                ...
                h('table.noselect.arrow', [
                    ...
                    h('tr', [
                        ...
                        h('td.cell-small', this.renderEditNumber(this.global, 'clearance')),
                    ]),
                    h('tr', [
                        h('th.cell-small', 'Diameter:'),
                        h('td.cell-small', this.renderEditNumber(this.global, 'diameter')),
                    ]),
                    h('tr', [
                        h('th.cell-small', 'Pass\u00A0Depth:'),
                        h('td.cell-small', this.renderEditNumber(this.global, 'passDepth')),
                    ]),
                    h('tr', [
                        h('th.cell-small', 'Stepover:'),
                        h('td.cell-small', this.renderEditNumber(this.global, 'stepover')),
                    ]),
                    h('tr', [
                        h('th.cell-small', 'Rapid\u00A0Rate:'),
                        h('td.cell-small', this.renderEditNumber(this.global, 'rapidRate')),
                    ]),
                    h('tr', [
                        h('th.cell-small', 'Plunge\u00A0Rate:'),
                        h('td.cell-small', this.renderEditNumber(this.global, 'plungeRate')),
                    ]),
                    h('tr', [
                        h('th.cell-small', 'Cut\u00A0Rate:'),
                        h('td.cell-small', this.renderEditNumber(this.global, 'cutRate')),
                    ]),
                ]),
            ]);
        },
